var anim = {
  //задаем условия анимации через переменную
  delay: 500,
  distance: '200px', //пространство для маневра анимации
  duration: 1000, //продолжительноть анимации
  easing: 'ease-in-out',
  rotate: { z: 10 }, //наклон 
...
window.sr = ScrollReveal()
  .reveal( '.unvisible', anim );    //для класса unvisible
...
window.sr = ScrollReveal()
  .reveal( '.unvisible2', anim2 );    //для класса unvisible2
  ...
  window.sr = ScrollReveal()
    .reveal( '.unvisible3', anim3 );    //для класса unvisible2
